...
const FloatingInput = forwardRef(function FloatingInput(
  { label, error, ...props }: FloatingInputProps,
  ...
  return (
    <div className="relative z-0 mt-4">
      <input
        id={`floating_${label}`}
        className={`block h-11 px-2 w-full text-sm bg-transparent rounded-md border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-primary peer disabled:disable ${
