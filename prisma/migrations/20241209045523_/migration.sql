/*
  ...
  - Added the required column `observation` to the `Enrolled` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_Enrolled" ("course_fk", "discount", "paid", "payment_date", "payment_type", "status", "student_fk", "ticket_num", "total") SELECT "course_fk", "discount", "paid", "payment_date", "payment_type", "status", "student_fk", "ticket_num", "total" FROM "Enrolled";
DROP TABLE "Enrolled";
