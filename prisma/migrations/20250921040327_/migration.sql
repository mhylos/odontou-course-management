...
-- CreateTable
CREATE TABLE "EnrollReceipt" (
    "id" SERIAL NOT NULL,
    "enroll_id" INTEGER NOT NULL,
    "date" TIMESTAMP(3) NOT NULL,

    CONSTRAINT "EnrollReceipt_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "EnrollReceipt_enroll_id_date_key" ON "EnrollReceipt"("enroll_id", "date");
...
-- AddForeignKey
ALTER TABLE "EnrollReceipt" ADD CONSTRAINT "EnrollReceipt_enroll_id_fkey" FOREIGN KEY ("enroll_id") REFERENCES "Enrolled"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
