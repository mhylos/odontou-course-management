...
INSERT INTO "new_Enrolled" ("course_fk", "discount", "paid", "payment_date", "payment_type", "student_fk", "ticket_num") SELECT "course_fk", "discount", "paid", "payment_date", "payment_type", "student_fk", "ticket_num" FROM "Enrolled";
DROP TABLE "Enrolled";
